...
class UpdateSortRowsColumnWorldwideQuotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('worldwide_quotes', function (Blueprint $table) {
            $table->enum('sort_rows_column', ['sku', 'service_sku', 'serial_no', 'product_name', 'expiry_date', 'price', 'service_level_description', 'vendor_short_code', 'machine_address'])
                ->nullable()
                ->after('margin_method')
