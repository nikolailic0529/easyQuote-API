...
class WorldwidePackQuoteTest extends TestCase
{
    ...
    public function testCanInitPackWorldwideQuote()
    {
        ...
        /** @var \App\Domain\Worldwide\Models\WorldwideQuote $quoteWithSameCustomer */
...
//            ->dump()
    ...
    public function testCanViewPackQuoteApplicableDiscounts()
    {
        ...
        /** @var \App\Domain\Worldwide\Models\WorldwideQuoteAssetsGroup $groupOfAssets */
...
//            ->dump()
            ...
            ->assertJsonStructure([
                ...
                'quote_summary' => [
                    ...
                    'end_user_company_email',
                    'end_user_hw_post_code',
                    'end_user_inv_post_code',
                    'list_price',
                    'final_price',
                    'applicable_discounts',
                    'sub_total_value',
...
//        file_put_contents("storage/framework/testing/ww-quotes/$expectedFileName", $response->content());
    ...
    public function testCanExportWorldwidePackQuoteWithGroupedAssets()
    {
        ...
        /** @var \App\Domain\Worldwide\Models\WorldwideQuoteAssetsGroup[] $groupsOfAssets */
...
//            ->dump()
        ...
        $this->getJson('api/ww-quotes/'.$quote->getKey())
            ...
            ->assertJsonFragment([
                'acting_user_is_version_owner' => true,
                'active_version_id' => $response->json('id'),
                'active_version_user_id' => $this->app['auth']->id(),
            ]);
    }
...
//            ->dump()
    ...
    public function testCanMoveRowsBetweenGroupsOfPackQuoteAssets()
    {
        ...
        /** @var \App\Domain\Worldwide\Models\WorldwideQuoteAssetsGroup $outputAssetsGroup */
