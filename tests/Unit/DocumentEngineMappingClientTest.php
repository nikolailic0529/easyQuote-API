...
use App\Domain\DocumentEngine\Exceptions\MappingException;
use App\Domain\DocumentEngine\MappingClient;
use App\Domain\DocumentEngine\Models\CreateDocumentHeaderData;
use App\Domain\DocumentEngine\Models\DocumentHeader;
use App\Domain\DocumentEngine\Models\DocumentHeaderAlias;
...
class DocumentEngineMappingClientTest extends TestCase
{
     ...
     */
    public function testItCanGetDocumentHeaders()
    {
     ...
     * @noinspection PhpDocMissingThrowsInspection
     */
    public function testItCanGetAliasesOfADocumentHeader()
    {
        $baseUrl = 'http://localhost:1337';
     ...
     * @noinspection PhpDocMissingThrowsInspection
     */
    public function testItCanGetParticularDocumentHeader()
    {
        $baseUrl = 'http://localhost:1337';
     ...
     * @noinspection PhpDocMissingThrowsInspection
     */
    public function testItCanCreateAliasesForDocumentHeader()
    {
        $baseUrl = 'http://localhost:1337';
     ...
     * @noinspection PhpDocMissingThrowsInspection
     */
    public function testItCanCreateANewDocumentHeader()
    {
        $baseUrl = 'http://localhost:1337';
     ...
     * @noinspection PhpDocMissingThrowsInspection
     */
    public function testItCanUpdateAnExistingHeader()
    {
        $baseUrl = 'http://localhost:1337';
     ...
     * @noinspection PhpDocMissingThrowsInspection
     */
    public function testItCanDeleteAnExistingHeader()
    {
        $baseUrl = 'http://localhost:1337';
     ...
     * @return void
     */
    public function testItPreventsDeleteASystemHeader()
    {
        $baseUrl = 'http://localhost:1337';
