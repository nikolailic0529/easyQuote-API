...
class HpeContractTest extends TestCase
{
    ...
    public function test_imports_20210125092647_123286_ch_s4_txt()
    {
        $this->authenticateApi();

        $filePath =  base_path('tests/Unit/Data/hpe-contract-test/20210125092647_123286_CH_S4.txt');
        ...
        $this->assertDatabaseHas('hpe_contract_data', [
            'hpe_contract_file_id' => $hpeContractFile->getKey(),
            'support_start_date' => '2021-06-01'
        ]);
    }

    public function test_imports_20210125083434_39516_gb_s4_txt()
    {
        $this->authenticateApi();

        $filePath =  base_path('tests/Unit/Data/hpe-contract-test/20210125083434_39516_GB_S4.txt');
    ...
    public function test_imports_83_b25755_4000021287_txt()
    {
        $this->authenticateApi();

        $filePath =  base_path('tests/Unit/Data/hpe-contract-test/83-B25755_4000021287.txt');
