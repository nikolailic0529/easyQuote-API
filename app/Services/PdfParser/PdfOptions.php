...
{
    const REGEXP_PRICE_LINES_01 = '/^(?<product_no>(?!software|hardware)\d+\-\w{3}|(?!software|hardware)[a-zA-Z]\w{3,12}?[a-zA-Z]{0,2})\s+(?<description>(.(?![\s\h]{4,}))+[\w\-\+]+)\s{2,}(?<serial_no>\d?[a-zA-Z\d]{7,11})\s+((?<date_from>(([0-2][0-9])|(3[0-1]))[\.\/]((0[0-9])|(1[0-2]))[\.\/]\d{4})\s+?(?=(([0-2][0-9])|(3[0-1]))[\.\/]((0[0-9])|(1[0-2]))[\.\/]\d{4}))?((?<date_to>(([0-2][0-9])|(3[0-1]))[\.\/]((0[0-9])|(1[0-2]))[\.\/]\d{4})\s+?)?(?<qty>\d{1,3}(?=\s+?))?(\s+(\p{Sc})?\s?(?<price>(\d{1,3},)?\d+([,\.]\d{1,4}))(?=\s))([a-zA-Z].+)?$/m';
    ...
    const REGEXP_PRICE_LINES_04 = '/^(?<product_no>\d+\-\w{3}|[a-zA-Z]\w{3,4}?[a-zA-Z]{1,2})\s+(?<description>(.(?![\s\h]{4,}))+Return to.*?[\w\-\+]+)\s+((?<date_from>(([0-2][0-9])|(3[0-1]))[\.\/]((0[0-9])|(1[0-2]))[\.\/]\d{4})\s+?(?=(([0-2][0-9])|(3[0-1]))[\.\/]((0[0-9])|(1[0-2]))[\.\/]\d{4}))?((?<date_to>(([0-2][0-9])|(3[0-1]))[\.\/]((0[0-9])|(1[0-2]))[\.\/]\d{4})\s+?)?(?<qty>\d{1,3}(?=\s+?))?(\s+(\p{Sc})?\s?(?<price>(\d{1,3},)?\d+([,\.]\d{1,4}))(?=\s))([a-zA-Z].+)?$/mi';
