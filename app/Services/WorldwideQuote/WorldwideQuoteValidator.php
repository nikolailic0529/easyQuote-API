...
//            "customer.vat_reg_no" => "required|max:20",
            ...
            'addresses.*.address_type.required' => 'One or more addresses don\'t have a defined type.',
            'addresses.*.address_1.required' => 'One or more addresses don\'t have a filled Address 1.',
            'addresses.*.address_1.max' => 'One or more addresses have Address 1 greater than :max characters.',
            'addresses.*.city.required' => 'One or more addresses don\'t have a filled City.',
            'addresses.*.city.max' => 'One or more addresses have City greater than :max characters.',
            'addresses.*.state.max' => 'One or more addresses have State greater than :max characters.',
            'addresses.*.state_code.max' => 'One or more addresses have State Code greater than :max characters.',
            'addresses.*.post_code.required' => 'One or more addresses don\'t have a filled Postal Code.',
            'addresses.*.post_code.max' => 'One or more addresses have State Postal Code greater than :max characters.',
            'addresses.*.country_code.required' => 'One or more addresses don\'t have a filled Country.',
