...
namespace App\Foundation\Process\Fork;

use App\Foundation\Process\Fork\Exceptions\CouldNotCreateForkException;
...
class Fork
{
    ...
    /** @var \App\Foundation\Process\Fork\Task[] */
    ...
    /**
     * @throws CouldNotCreateForkException
     */
    public function __construct()
    {
        if (!function_exists('pcntl_fork')) {
            throw new CouldNotCreateForkException('Cannot create process forks: PCNTL is not supported on this system.');
        }
    }
