...
class CustomerResponseResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'support_start_date'    => Carbon::parse($this->getRawOriginal('support_start'))->format('Y-m-d'),
            'support_end_date'      => Carbon::parse($this->getRawOriginal('support_end'))->format('Y-m-d'),
