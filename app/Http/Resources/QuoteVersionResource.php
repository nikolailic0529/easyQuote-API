...
class QuoteVersionResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'country_id'                                => $this->usingVersion->country_id,
            ...
            'exchange_rate_margin'                      => $this->usingVersion->exchange_rate_margin,
            ...
            'use_groups'                                => $this->usingVersion->use_groups && $this->usingVersion->has_group_description,
            ...
            'company'                                   => CompanyResource::make($this->usingVersion->company),
