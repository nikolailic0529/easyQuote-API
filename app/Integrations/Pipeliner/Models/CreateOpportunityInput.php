...
{
    public function __construct(#[SerializeWith(DateTimeSerializer::class, 'Y-m-d')] public readonly DateTimeImmutable $closingDate,
                                public readonly string $name,
                                public readonly string $ownerId,
                                public readonly string $stepId,
                                public readonly CreateOpptyAccountRelationInputCollection $accountRelations,
