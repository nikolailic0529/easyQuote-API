...
class AppointmentEntity
{
    ...
    public static function fromArray(array $array): static
    {
        return new static(
            ...
            accountRelations: array_map(ActivityAccountRelationEntity::fromArray(...), array_column($array['accountRelations']['edges'], 'node')),
            contactRelations: array_map(ActivityContactRelationEntity::fromArray(...), array_column($array['contactRelations']['edges'], 'node')),
            opportunityRelations: array_map(ActivityLeadOpptyRelationEntity::fromArray(...), array_column($array['opportunityRelations']['edges'], 'node')),
            inviteesClients: array_map(ActivityClientRelationEntity::fromArray(...), array_column($array['inviteesClients']['edges'], 'node')),
            inviteesContacts: array_map(ActivityContactInviteesRelationEntity::fromArray(...), array_column($array['inviteesContacts']['edges'], 'node')),
