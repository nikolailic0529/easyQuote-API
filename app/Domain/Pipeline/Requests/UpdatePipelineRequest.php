...
class UpdatePipelineRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'pipeline_stages.*.id' => [
                ...
                Rule::exists(\App\Domain\Pipeline\Models\PipelineStage::class, 'id')->where('pipeline_id', $this->getPipelineModel()->getKey()),
            ],
    ...
    public function getPipelineModel(): \App\Domain\Pipeline\Models\Pipeline
    {
