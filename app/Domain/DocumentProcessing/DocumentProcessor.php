...
namespace App\Domain\DocumentProcessing;

use App\Domain\Date\Enum\DateFormatEnum;
use App\Domain\DocumentMapping\DataTransferObjects\MappedRowData;
...
use App\Domain\DocumentProcessing\Exceptions\DocumentComparisonException;
...
class DocumentProcessor extends Manager implements ManagesDocumentProcessors
{
    ...
    public function forwardProcessor(QuoteFile $quoteFile): void
    {
        ...
        /** @var \App\Domain\DocumentProcessing\Models\DocumentProcessLog $processLog */
    ...
    public function transitImportedRowsToMappedRows(QuoteFile $quoteFile, RowMapping $rowMapping, ?MappingConfig $mappingConfig = null)
    {
        ...
        /** @var \App\Domain\DocumentMapping\Models\MappedRow[] */
        $mappedRows = [];
