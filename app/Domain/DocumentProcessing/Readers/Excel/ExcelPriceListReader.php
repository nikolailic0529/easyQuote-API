...
namespace App\Domain\DocumentProcessing\Readers\Excel;

use App\Domain\DocumentProcessing\Readers\Models\HeadingRow;
use App\Domain\DocumentProcessing\Readers\Models\Row as DocumentRow;
use App\Domain\DocumentProcessing\Readers\Validation\RowContainsOnePayMention;
use App\Domain\DocumentProcessing\Readers\Validation\RowContainsOnlySerialNumberMention;
use App\Domain\DocumentProcessing\Readers\Validation\RowContainsOnlySubtotal;
use App\Domain\DocumentProcessing\Readers\Validation\RowIsNotSameAsHeader;
use App\Domain\DocumentProcessing\Readers\Validation\RowValidationPayload;
use App\Domain\DocumentProcessing\Readers\Validation\RowValidationPipeline;
use App\Domain\DocumentProcessing\Readers\Validation\RowValuesMatchAnyCombination;
...
//        dd($headerRow->toArray(), $nextRow->toArray());
        ...
        $mergedColumnIndexes = value(function () use ($headerRow): array {
