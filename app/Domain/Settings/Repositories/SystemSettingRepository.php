...
class SystemSettingRepository implements \App\Domain\Settings\Contracts\SystemSettingRepositoryInterface
{
    ...
    {
        DB::transaction(
            fn () => $this->systemSetting->whereIn('key', array_keys($map))->get()
