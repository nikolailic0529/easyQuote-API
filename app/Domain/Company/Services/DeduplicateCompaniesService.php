...
use App\Domain\Company\Services\Models\MergedCompanyRelations;
...
class DeduplicateCompaniesService implements LoggerAware
{
    ...
    public function performDeduplicationOf(Collection $companies): void
    {
        ...
        /** @var \App\Domain\Company\Models\Company $candidate */
    ...
    private function mergeAttributesFromDuplicates(Company $candidate, Company ...$duplicates): array
    {
        $coalesceAttributes = [
             ...
             * @uses \App\Domain\Company\Models\Company::$vat
             * @uses Company::$vat_type
             * @uses Company::$type
             * @uses \App\Domain\Company\Models\Company::$category
             * @uses Company::$source
             * @uses Company::$email
             * @uses \App\Domain\Company\Models\Company::$website
