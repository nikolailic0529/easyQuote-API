...
{
    protected ?\App\Domain\Template\DataTransferObjects\UpdateQuoteTemplateData $updateQuoteTemplateData = null;
    ...
    public function getUpdateQuoteTemplateData(): \App\Domain\Template\DataTransferObjects\UpdateQuoteTemplateData
    {
        /** @var QuoteTemplate $quoteTemplate */
        $quoteTemplate = $this->route('template');

        return $this->updateQuoteTemplateData ??= new \App\Domain\Template\DataTransferObjects\UpdateQuoteTemplateData([
