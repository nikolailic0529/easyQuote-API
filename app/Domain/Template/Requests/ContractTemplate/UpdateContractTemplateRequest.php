...
use App\Domain\Template\DataTransferObjects\UpdateContractTemplateData;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class UpdateContractTemplateRequest extends FormRequest
{
    protected ?\App\Domain\Template\DataTransferObjects\UpdateContractTemplateData $updateContractTemplateData = null;
