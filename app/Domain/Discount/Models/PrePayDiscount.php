 ...
 */
class PrePayDiscount extends Discount implements SearchableEntity
{
    ...
    {
        return $this->hasMany(WorldwideQuoteVersion::class, 'pre_pay_discount_id');
    }
    ...
    {
        return $this->hasMany(WorldwideDistribution::class, 'pre_pay_discount_id');
    }
