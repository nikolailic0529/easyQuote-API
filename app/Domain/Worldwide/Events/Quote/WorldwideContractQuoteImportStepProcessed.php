...
final class WorldwideContractQuoteImportStepProcessed implements WithWorldwideQuoteEntity
{
    use Dispatchable;
     ...
     */
    public function __construct(WorldwideQuote $quote, WorldwideQuote $oldQuote, ?User $actingUser = null)
    {
        $this->quote = $quote;
