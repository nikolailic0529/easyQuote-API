...
final class OpportunityMarkedAsNotLost implements WithOpportunityEntity, WithCauserEntity
{
    use Dispatchable;
    use SerializesModels;

    public function __construct(private Opportunity $opportunity, private ?Model $causer)
    {
    }
