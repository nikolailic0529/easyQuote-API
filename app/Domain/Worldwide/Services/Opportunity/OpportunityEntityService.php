...
use App\Domain\Worldwide\DataTransferObjects\Opportunity\UpdateSupplierData;
...
class OpportunityEntityService implements CauserAware
{
    ...
    public function createOpportunity(CreateOpportunityData $data): Opportunity
    {
        ...
        return tap(new Opportunity(), function (Opportunity $opportunity) use ($data) {
            ...
            $opportunity->nature_of_service = (string) $data->nature_of_service;
            $opportunity->renewal_month = $data->renewal_month;
            $opportunity->renewal_year = $data->renewal_year;
            $opportunity->customer_status = (string) $data->customer_status;
            $opportunity->end_user_name = (string) $data->end_user_name;
            $opportunity->hardware_status = (string) $data->hardware_status;
            $opportunity->region_name = (string) $data->region_name;
            ...
            $opportunity->notes = (string) $data->notes;

            $recurrence = isset($data->recurrence)
                ? tap(new OpportunityRecurrence(),
                    function (OpportunityRecurrence $recurrence) use (
                        $data,
                        $opportunity
                    ): void {
            ...
            $this->connection->transaction(static function () use ($opportunity, $recurrence): void {
                $opportunity->save();
            ...
            $opportunity->opportunitySuppliers->each->unsetRelation('opportunity');
    ...
    public function updateOpportunity(Opportunity $opportunity, UpdateOpportunityData $data): Opportunity
    {
        ...
        return tap($opportunity, function (Opportunity $opportunity) use ($lock, $data) {
            $opportunity->notes = (string) $opportunity->notes;
            $opportunity->service_level_agreement_id = (string) $opportunity->service_level_agreement_id;
            $opportunity->competition_name = (string) $opportunity->competition_name;
            $opportunity->nature_of_service = (string) $opportunity->nature_of_service;
            $opportunity->customer_status = (string) $opportunity->customer_status;
            $opportunity->end_user_name = (string) $opportunity->end_user_name;
            $opportunity->hardware_status = (string) $opportunity->hardware_status;
            $opportunity->region_name = (string) $opportunity->region_name;
            $opportunity->syncOriginal();
            ...
            if ($data->recurrence instanceof CreateOpportunityRecurrenceData) {
                $recurrence = tap($opportunity->recurrence ?? new OpportunityRecurrence(),
                    function (OpportunityRecurrence $recurrence) use (
                        $data,
                        $opportunity
                    ): void {
            ...
            $lock->block(30, function () use ($opportunity, $recurrence) {
                $this->connection->transaction(static function () use ($recurrence, $opportunity): void {
                    $opportunity->save();
                    $opportunity->opportunitySuppliers->each->save();
                    ...
                    } elseif ($recurrence instanceof OpportunityRecurrence) {
                        $recurrence->save();
                    }
                });
            });
    ...
    public function setStageOfOpportunity(Opportunity $opportunity, SetStageOfOpportunityData $data): Opportunity
    {
        ...
        return tap($opportunity, function (Opportunity $opportunity) use ($data): void {
            /** @var \App\Domain\Pipeline\Models\PipelineStage $stage */
