...
use App\Domain\Worldwide\DataTransferObjects\Quote\AssetServiceLookupResult;
...
use App\Domain\Worldwide\DataTransferObjects\Quote\ReadAssetRow;
...
class WorldwideQuoteAssetStateProcessor implements ProcessesWorldwideQuoteAssetState
{
    ...
    public function batchUpdateQuoteAssets(WorldwideQuoteVersion $quote, WorldwideQuoteAssetDataCollection $collection)
    {
        ...
        /**
         * @var \App\Domain\Worldwide\Models\WorldwideQuoteAsset[] $assetModels
         */
     ...
     * @param \App\Domain\Worldwide\Models\WorldwideQuoteAsset[] $assetBatch
     *
