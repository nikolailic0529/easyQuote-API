...
use App\Domain\Worldwide\Services\WorldwideQuote\Models\ReplicatedAddressesData;
use App\Domain\Worldwide\Services\WorldwideQuote\Models\ReplicatedContactsData;
use App\Domain\Worldwide\Services\WorldwideQuote\Models\ReplicatedDistributorQuoteData;
...
class WorldwideQuoteReplicator
{
    ...
    protected function replicateQuoteNote(WorldwideQuoteVersion $activeVersion, WorldwideQuoteVersion $replicatedVersion): ?Note
    {
        ...
        return tap(new Note(), function (Note $note) use ($activeVersion) {
...
//            $note->user()->associate($replicatedVersion->user_id);
    ...
    protected function replicateDistributorQuote(WorldwideDistribution $distributorQuote, WorldwideQuoteVersion $replicatedQuoteVersion): ReplicatedDistributorQuoteData
    {
        ...
        /** @var \App\Domain\QuoteFile\Models\QuoteFile|null $replicatedDistributorFile */
        ...
        /** @var \App\Domain\DocumentMapping\Models\MappedRow[] $replicatedMappedRows */
        ...
        /** @var \App\Domain\QuoteFile\Models\QuoteFile|null $replicatedScheduleFile */
