...
class WorldwideQuoteState extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'sharing_users' => UserRelationResource::collection($this->whenLoaded('sharingUsers')),

            'quote_number' => $this->quote_number,

            'opportunity_id' => $this->opportunity_id,
            'opportunity' => $this->when($this->relationLoaded('opportunity') || $this->activeVersion->relationLoaded('addresses') || $this->activeVersion->relationLoaded('contacts'),
                function () {
            ...
            'output_currency' => value(function () {
                /** @var \App\Domain\Worldwide\Models\WorldwideQuote $this */
