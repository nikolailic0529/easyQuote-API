...
final class UpdateRoleRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'privileges.*.module' => ['bail', 'required', 'string', Rule::in(array_keys(config('role.modules')))],
            'privileges.*.privilege' => [
                'bail', 'required', 'string',
                new ValidModulePrivilege(config('role.modules')),
            ],
    ...
    public function getUpdateRoleData(): UpdateRoleData
    {
