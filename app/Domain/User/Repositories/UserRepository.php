...
use App\Domain\Authentication\Requests\PasswordResetRequest as AppPasswordResetRequest;
...
use App\Domain\User\Notifications\PasswordResetRequest;
use App\Domain\User\Notifications\{PasswordResetSuccess};
...
class UserRepository extends SearchableRepository implements UserRepositoryInterface
{
    ...
    {
        return [
            \App\Domain\User\Queries\Filters\OrderByCreatedAt::class,
            \App\Domain\User\Queries\Filters\OrderByEmail::class,
            \App\Domain\User\Queries\Filters\OrderByName::class,
            \App\Domain\User\Queries\Filters\OrderByFirstname::class,
            \App\Domain\User\Queries\Filters\OrderByLastname::class,
            \App\Domain\User\Queries\Filters\OrderByRole::class,
