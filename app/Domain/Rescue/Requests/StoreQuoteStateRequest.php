...
use App\Domain\Rescue\Validation\Rules\UniqueCustomer;
use App\Domain\Rescue\Validation\Rules\{UseRowGroups};
...
class StoreQuoteStateRequest extends FormRequest
{
    ...
    protected ?\App\Domain\Rescue\Models\Quote $quote = null;
    ...
    {
        return [
            'quote_id' => ['bail', 'uuid', Rule::exists(\App\Domain\Rescue\Models\Quote::class, 'id')->whereNull('deleted_at')],
            ...
            'margin.quote_type' => [
                ...
                Rule::in(\App\Domain\Rescue\Models\BaseQuote::TYPES),
            ],
            'margin.method' => [
    ...
    public function getQuote(): \App\Domain\Rescue\Models\Quote
    {
        if (isset($this->quote)) {
            return $this->quote;
        }
        ...
        return $this->quote = $this->has('quote_id')
            ? \App\Domain\Rescue\Models\Quote::findOrFail($this->quote_id)
