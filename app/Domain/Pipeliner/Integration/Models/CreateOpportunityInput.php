...
use App\Domain\Pipeliner\Integration\Enum\OpportunityLabelFlag;
...
final class CreateOpportunityInput extends BaseInput
{
    public function __construct(
        ...
        public readonly CreateOpportunitySharingClientRelationInputCollection|InputValueEnum $sharingClients = InputValueEnum::Miss,
    ) {
    }
}
