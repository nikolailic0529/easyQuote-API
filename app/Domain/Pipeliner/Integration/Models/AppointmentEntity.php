...
/**
 * @property ActivityAccountRelationEntity[]         $accountRelations
 * @property ActivityContactRelationEntity[]         $contactRelations
 * @property ActivityLeadOpptyRelationEntity[]       $opportunityRelations
 * @property ActivityClientRelationEntity[]          $inviteesClients
 * @property ActivityContactInviteesRelationEntity[] $inviteesContacts
 * @property CloudObjectEntity[]                     $documents
 */
